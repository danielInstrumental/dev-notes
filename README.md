...
A running notebook of things I learn while building projects.
...
| [`.ai/`](.ai/) | Working on this repo itself — the session handoff log (where I left off) and the TODO (what's left) |
| [`lessons/`](lessons/) | Takeaways from projects — what worked, what broke, what I'd change |

## How I use this

Whenever I hit a new term, make a mistake worth remembering, or write something I'll want again, it goes in here.
